...
const About = () => {
  ...
  return (
    <section
      id="About"
      className="max-w-6xl mx-auto px-6 py-20 text-white flex flex-col md:flex-row items-center md:items-start gap-12"
    >
      {/* Image */}
      <motion.div
      ...
      <motion.div className="flex-1 space-y-6 text-text-primary text-lg leading-relaxed">
        ...
        >
          ...
          >
            <FaUserCircle className="text-accent text-2xl flex-shrink-0" />I am
            a passionate frontend developer who crafts clean, user-friendly, and
            performant websites.
          </motion.p>
          ...
          >
            ...
            Skilled in modern JavaScript frameworks like React, CSS, and smooth
            animations.
          </motion.p>
